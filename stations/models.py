...
class FuelStation(models.Model):
    ...
    gasoline_tank1_stock = models.PositiveIntegerField('موجودی مخزن شماره ۱ بنزین',null=True, blank=True) # موجودی مخزن شماره ۱ بنزین
    gasoline_tank2_stock = models.PositiveIntegerField('موجودی مخزن شماره ۲ بنزین',null=True, blank=True) # موجودی مخزن شماره ۲ بنزین
    ...
    gas_tank1_stock = models.PositiveIntegerField('موجودی مخزن شماره ۱ گاز',null=True, blank=True) # موجودی مخزن شماره ۱ گاز
    gas_tank2_stock = models.PositiveIntegerField('موجودی مخزن شماره ۲ گاز',null=True, blank=True) # موجودی مخزن شماره ۲ گاز
